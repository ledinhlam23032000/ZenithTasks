...
- **A4 chuẩn chỉ có một trang PDF**: cắt phần canvas trắng dư trước khi xuất, thay vì tạo trang hai trắng; nội dung thực sự dài vẫn phân trang.
...
- **Không đổi dữ liệu tài chính/y tế hay migration**: kiểm thử hồi quy hai mẫu đạt 12/12; TypeScript, ESLint và production build đều đạt trước khi phát hành.
