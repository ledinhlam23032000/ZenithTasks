...
const WORKSPACES: Record<CaseWorkspace["key"], CaseWorkspace> = {
  admin: {
    ...
    description: "Đầy đủ hồ sơ, tài chính và phân bổ doanh số; quyền server-side vẫn là lớp bảo vệ cuối.",
    defaultTab: "tu-van",
  ...
  clinical: {
    ...
    description: "Ưu tiên tư vấn, dịch vụ, vật tư, hình ảnh và giấy tờ của ca.",
    defaultTab: "tu-van",
