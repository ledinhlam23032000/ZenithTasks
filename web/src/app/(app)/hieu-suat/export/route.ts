...
export async function GET(req: Request) {
  ...
  const columns = ["Nhân viên", "Vai trò", "Ngày công", "Ca tư vấn", "Chốt (%)", "DS tư vấn", "Ca mổ", "DS mổ", "Tin CSKH"];
  const data: Cell[][] = rows.map((r) => [r.name, ROLE_LABELS[r.role], r.daysWorked, r.consultCases, r.consultRate, r.consultRevenue, r.doctorCases, r.doctorRevenue, r.careCount]);
