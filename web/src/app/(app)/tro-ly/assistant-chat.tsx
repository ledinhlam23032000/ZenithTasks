...
export type AssistantWorkspaceOption = { id: string; code: string; name: string; enabledFeatures: string[] };
    ...
    <div className="flex h-[calc(100vh-10.5rem)] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div className="flex items-center gap-2.5 border-b border-slate-100 px-4 py-3">
        ...
        <div className="leading-tight">
          ...
          <p className="text-xs text-slate-400">Đồng nghiệp số · Phạm vi: <span className="font-semibold text-slate-600">{activeWorkspaceLabel}</span></p>
        </div>
        {turns.length > 0 && (
