...
import { handleVnInvalid, clearVnValidity } from "@/lib/form-validation";
...
export const Input = React.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement>>(
  ({ className, onInvalid, onInput, ...props }, ref) => (
    <input
      ref={ref}
      className={cn(baseField, "h-11 sm:h-10", className)}
      onInvalid={(e) => { handleVnInvalid(e); onInvalid?.(e); }}
      onInput={(e) => { clearVnValidity(e); onInput?.(e); }}
      {...props}
    />
  ),
);
...
export const Textarea = React.forwardRef<HTMLTextAreaElement, React.TextareaHTMLAttributes<HTMLTextAreaElement>>(
  ({ className, onInvalid, onInput, ...props }, ref) => (
    <textarea
      ref={ref}
      className={cn(baseField, "py-2.5 min-h-[84px]", className)}
      onInvalid={(e) => { handleVnInvalid(e); onInvalid?.(e); }}
      onInput={(e) => { clearVnValidity(e); onInput?.(e); }}
      {...props}
    />
