...
| Mã | Hạng mục | Trạng thái | Ghi chú |
|----|----------|-----------|---------|
| B1 | **Trung tâm nhắc & thông báo tự động** | ✅ Lõi + Web Push + workflow | Trang **"Việc cần làm hôm nay"** (`/viec-hom-nay`) tổng hợp tái khám, hẹn, công nợ, sinh nhật, khách nguội và kho cảnh báo. Hộp thư có Web Push, người phụ trách, trạng thái xử lý và SLA. ⏳ Còn: tự động hóa lịch chạy theo từng quy tắc nghiệp vụ. |
