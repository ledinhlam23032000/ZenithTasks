...
> **Phiên bản nội bộ:** `2026.09.23-r3-payment-pdf`<br>
...
> **Trạng thái:** Bản vá Giấy đề nghị thanh toán: có PDF tải trực tiếp từ giấy A4 đã render để giữ hình thức/phông; phần canvas trắng dư được bỏ để A4 chuẩn không sinh trang hai; nút `In / Lưu PDF` của Giấy đề nghị và Hồ sơ dịch vụ thẩm mỹ hoạt động lại qua CSP nonce, không nới bảo mật. Không migration hoặc đổi dữ liệu. Gate: TypeScript, ESLint, production build và 12 test hồi quy liên quan đều đạt.
